```bash
brendo@brdneo:~$ ls
about  skills  interests  contact

brendo@brdneo:~$ cd about
brendo@brdneo:~/about$ ls
user.txt
...
brendo@brdneo:~/about$ cd ../skills
brendo@brdneo:~/skills$ ls
main.txt  learning.txt

brendo@brdneo:~/skills$ cat main.txt
...
brendo@brdneo:~/interests$ cd ../contact
brendo@brdneo:~/contact$ ls
contact.txt

brendo@brdneo:~/contact$ cat contact.txt
LinkedIn: linkedin.com/in/brdneo
Discord: @brdneo
Mail: brendo@lavache.com
```
